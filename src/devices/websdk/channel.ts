...
function getWebSdk(): typeof WebSdk {
    if (typeof window === "undefined" || typeof window.WebSdk === "undefined") {
        throw new Error("WebSdk is not available. Make sure it's loaded in the browser environment.");
    }
...
export class Channel {
    ...
    constructor(channelName: string, options?: any) {
        const WebSdk = getWebSdk(); // 🧠 safe lazy access
